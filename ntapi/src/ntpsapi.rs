...
use crate::ntdef::*;
use crate::ntioapi::PCOBJECT_ATTRIBUTES;
use crate::ntpebteb::*;
...
pub union PROCESS_EXTENDED_BASIC_INFORMATION_FLAGS {
    pub Flags: ULONG,
    pub bits: ManuallyDrop<PROCESS_EXTENDED_BASIC_INFORMATION_FLAGS_BITS>,
}
...
pub struct INITIAL_TEB {
    pub OldInitialTeb: INITIAL_TEB_OLD,
    pub StackBase: PVOID,
...
pub union PS_STD_HANDLE_INFO_U {
    pub Flags: ULONG,
    pub bits: ManuallyDrop<PS_STD_HANDLE_INFO_BITS>,
}
...
pub union PS_CREATE_INFO_U {
    pub InitState: ManuallyDrop<PS_CREATE_INFO_U_INIT_STATE>,
    pub FileHandle: HANDLE,
    pub DllCharacteristics: USHORT,
    pub IFEOKey: HANDLE,
    pub SuccessState: ManuallyDrop<PS_CREATE_INFO_U_SUCCESS_STATE>,
}
...
pub union PS_CREATE_INFO_INIT_FLAGS {
    pub InitFlags: ULONG,
    pub bits: ManuallyDrop<PS_CREATE_INFO_INIT_FLAGS_BITS>,
}
...
pub union PS_CREATE_INFO_SUCCESS_OUTPUT_FLAGS {
    pub OutputFlags: ULONG,
    pub bits: ManuallyDrop<PS_CREATE_INFO_SUCCESS_OUTPUT_FLAGS_BITS>,
}
